...
Player.prototype = {
    ...
    play: function (index) {
        ...
        /*If user нажимает пуск музыки аудио автоматически выключается и начинает играть та которую запустили.
        * при клике на паузу не выключать трек, а останавливать его на текущем времени*/
        if (list.length > 0) {
            list[0].stop();
            list.splice(0, 1);
        }
